    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                permission: 'manage_cancel_requests',
            },
            {
                name: 'Flash Sale',
                route: 'admin.flash-sales.index',
                icon: 'M13 10V3L4 14h7v7l9-11h-7z',
                permission: 'manage_flash_sales',
            },
        ],
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                route: 'admin.accounting.voucher-usage',
                icon: 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z',
                permission: 'view_voucher_usage',
            },
            {
                name: 'Báo cáo Công nợ',
                route: 'admin.accounting.debt-report',
                icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
                permission: 'view_debt_report',
            },
            {
                name: 'Reconcile Thanh toán',
                route: 'admin.accounting.payment-reconciliation',
                icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',
                permission: 'view_debt_report',
            },
            {
                name: 'Đối soát Tồn kho',
                route: 'admin.accounting.inventory-valuation',
                icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
                permission: 'view_inventory_valuation',
            },
            {
