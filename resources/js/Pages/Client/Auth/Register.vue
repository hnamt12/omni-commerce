...
<template>
    ...
    <div class="min-h-screen flex">
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <label for="agree" class="text-sm text-gray-600 cursor-pointer leading-relaxed">
                            ...
                            và
                            <a href="#" class="font-semibold text-indigo-600 hover:underline">Chính sách bảo mật</a>.
                        </label>
                    </div>
        ...
        <div class="hidden lg:block lg:w-1/2 relative bg-gray-900 overflow-hidden">
            <img :src="authBanner" alt="Register Banner" class="absolute inset-0 w-full h-full object-cover opacity-80 transition-opacity duration-700">
            <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent"></div>
            <div class="absolute bottom-12 left-12 right-12 text-white">
                <div class="mb-4 space-y-2">
                    <div class="flex items-center gap-2 text-sm"><span class="text-yellow-400 text-lg">⚡</span><span class="font-semibold">Flash Sale ưu tiên: truy cập trước 15 phút</span></div>
                    <div class="flex items-center gap-2 text-sm"><span class="text-green-400 text-lg">🎁</span><span class="font-semibold">Voucher chào mừng: giảm ngay 50.000đ</span></div>
                    <div class="flex items-center gap-2 text-sm"><span class="text-blue-400 text-lg">📦</span><span class="font-semibold">Theo dõi đơn hàng real-time</span></div>
                </div>
                <h3 class="text-4xl font-extrabold mb-3 leading-tight">Tham gia ngay hôm nay.</h3>
                <p class="text-gray-300 text-base">Miễn phí. Không ràng buộc. Ưu đãi ngay khi đăng ký.</p>
            </div>
        </div>
    </div>
</template>
