    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 xl:px-24 bg-white dark:bg-slate-900 relative z-10 transition-colors duration-300">
            <div class="w-full max-w-md mx-auto">
                ...
                <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-1">Chào mừng trở lại! 👋</h2>
                <p class="text-gray-500 dark:text-gray-400 mb-8 text-sm">Đăng nhập để tiếp tục mua sắm.</p>
                ...
                <div class="relative flex items-center mb-6">
                    ...
                    <span class="flex-shrink-0 mx-4 text-gray-400 dark:text-gray-500 text-xs">Hoặc đăng nhập bằng Email</span>
                    <div class="flex-grow border-t border-gray-200 dark:border-slate-700"></div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Mật khẩu</label>
                        <div class="relative">
                    ...
                    <div class="flex items-center -mt-1 mb-2">
                        ...
                        <label for="remember" class="ml-2 text-sm text-gray-600 dark:text-gray-400 cursor-pointer">Ghi nhớ đăng nhập</label>
                    </div>

                    <div class="flex items-center justify-between gap-4 mt-4">
                        <Link :href="route('client.password.request')" class="text-sm font-semibold text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline transition-colors shrink-0">Quên mật khẩu?</Link>
