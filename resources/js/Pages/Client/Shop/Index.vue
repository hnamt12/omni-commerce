        ...
        <div class="bg-gray-100 w-full min-h-screen pb-12">
            <div class="w-full max-w-[1200px] mx-auto px-4 pt-6">
                ...
                <nav class="text-xs text-gray-400 mb-5 flex items-center gap-1.5">
                    ...
                    <span>/</span>
                    <span class="text-gray-700 font-medium">Cửa hàng</span>
                </nav>
                ...
                <div class="flex gap-5 items-start">
                    ...
                    <aside class="w-64 shrink-0 space-y-4">
                        ...
                        <!-- Header -->
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 px-4 py-3 flex items-center justify-between">
                            <h2 class="font-black text-sm text-gray-800 uppercase tracking-wider">Bộ lọc</h2>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                            <p class="text-xs font-black text-gray-500 uppercase tracking-wider mb-2">Sắp xếp</p>
                            <select v-model="form.sort"
                                class="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-white">
                        ...
                        <!-- Price Range -->
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                            <p class="text-xs font-black text-gray-500 uppercase tracking-wider mb-3">Mức giá</p>
                            <div class="flex items-center gap-2">
                                <input v-model="form.min_price" type="number" placeholder="Từ"
                                    class="w-full text-sm border border-gray-200 rounded-lg px-2.5 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400">
                        ...
                        <!-- Categories -->
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                            <p class="text-xs font-black text-gray-500 uppercase tracking-wider mb-3">Danh mục</p>
                            <div class="space-y-2 max-h-52 overflow-y-auto pr-1">
                                <label v-for="cat in categories" :key="cat.id"
                                    ...
                                    <span class="text-sm text-gray-700 group-hover:text-indigo-600 transition flex-1 leading-tight">
                                        {{ cat.name }}
                                    </span>
                        ...
                        <!-- Brands -->
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                            <p class="text-xs font-black text-gray-500 uppercase tracking-wider mb-3">Thương hiệu</p>
                            <div class="space-y-2 max-h-52 overflow-y-auto pr-1">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <p class="text-sm text-gray-500">
                                <span class="font-bold text-gray-800">{{ products.total }}</span> sản phẩm
                            </p>
                        </div>
                        ...
                        <div v-else class="bg-white rounded-2xl border border-gray-100 shadow-sm p-16 text-center">
                            ...
                            <p class="font-bold text-gray-700 text-lg">Không tìm thấy sản phẩm</p>
                            <p class="text-gray-400 text-sm mt-1">Thử điều chỉnh bộ lọc để xem thêm kết quả.</p>
